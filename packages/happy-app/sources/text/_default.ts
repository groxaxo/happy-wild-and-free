/**
 * English translations for the Huppie app
 * Values can be:
...
export const en = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Huppie Coder is a Codex and Claude Code mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
    ...
    server: {
        ...
        notValidHappyServer: 'Not a valid Huppie Server',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Huppie Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Huppie Session ID',
        happySessionId: 'Huppie Session ID',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Install the Huppie CLI',
            runIt: 'Run it',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Use your own ElevenLabs agent instead of the Huppie default. No subscription required — connect directly with your own ElevenLabs account. Your agent must define two client tools: messageClaudeCode (sends text to the coding agent) and processPermissionRequest (allows or denies tool use). It receives session context via the {{initialConversationContext}} dynamic variable.',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: 'Not configured',
        customAgentIdDescription: 'Enter your ElevenLabs agent ID. Leave empty to use the Huppie default.',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: 'Direct Connection',
        bypassTokenSubtitle: 'Skip Huppie server, connect straight to ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Huppie Coder account. This will allow the terminal to send and receive messages securely.',
