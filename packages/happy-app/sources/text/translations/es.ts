...
/**
 * Spanish translations for the Huppie app
...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Huppie Coder es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    server: {
        ...
        notValidHappyServer: 'No es un servidor Huppie válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de sesión de Huppie copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de Huppie',
        happySessionId: 'ID de sesión de Huppie',
        ...
        happyHome: 'Directorio de Huppie',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale el Huppie CLI',
            runIt: 'Ejecútelo',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Huppie Coder. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
