...
/**
 * Portuguese (Brazilian) translations for the Huppie app
...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Huppie Coder é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    server: {
        ...
        notValidHappyServer: 'Não é um servidor Huppie válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID da sessão Huppie copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão Huppie',
        happySessionId: 'ID da sessão Huppie',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale o Huppie CLI',
            runIt: 'Execute',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Huppie Coder. Isso permitirá que o terminal envie e receba mensagens com segurança.',
