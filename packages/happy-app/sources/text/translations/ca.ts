...
/**
 * Catalan translations for the Huppie app
...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Huppie Coder és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    server: {
        ...
        notValidHappyServer: 'No és un servidor Huppie vàlid',
        ...
        useLocalServer: 'Usa el servidor local'
    },
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de la sessió de Huppie copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Huppie',
        happySessionId: 'ID de la sessió de Huppie',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instal·la el Huppie CLI',
            runIt: 'Executa\'l',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de Huppie Coder. Això permetrà al terminal enviar i rebre missatges de forma segura.',
