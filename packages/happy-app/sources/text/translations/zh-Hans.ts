/**
 * Chinese (Simplified) translations for the Huppie app
 * Values can be:
...
export const zhHans: TranslationStructure = {
    ...
    settings: {
        ...
        about: '关于',
        aboutFooter: 'Huppie Coder 是一个 Codex 和 Claude Code 移动客户端。它采用端到端加密，您的账户仅存储在本地设备上。与 Anthropic 无关联。',
        whatsNew: '更新日志',
    ...
    server: {
        ...
        notValidHappyServer: '不是有效的 Huppie 服务器',
        changeServer: '更改服务器',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Huppie 会话 ID 已复制到剪贴板',
        failedToCopySessionId: '复制 Huppie 会话 ID 失败',
        happySessionId: 'Huppie 会话 ID',
    ...
    settingsVoice: {
        ...
        byoTitle: '使用自己的代理',
        byoDescription: '使用您自己的 ElevenLabs 代理代替 Huppie 默认代理。无需订阅 — 直接使用您自己的 ElevenLabs 账户连接。您的代理必须定义两个客户端工具：messageClaudeCode（向编码代理发送文本）和 processPermissionRequest（允许或拒绝工具使用）。通过 {{initialConversationContext}} 动态变量接收会话上下文。',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: '未配置',
        customAgentIdDescription: '输入您的 ElevenLabs Agent ID。留空则使用 Huppie 默认代理。',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: '直接连接',
        bypassTokenSubtitle: '跳过 Huppie 服务器，直接连接到 ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: '有终端正在请求连接到您的 Huppie Coder 账户。这将允许终端安全地发送和接收消息。',
